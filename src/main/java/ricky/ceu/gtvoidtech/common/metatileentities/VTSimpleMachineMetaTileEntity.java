...
public class VTSimpleMachineMetaTileEntity extends SimpleMachineMetaTileEntity {

    private static final int FONT_HEIGHT = 9; // Minecraft's FontRenderer FONT_HEIGHT value

    public VTSimpleMachineMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap,
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new VTSimpleMachineMetaTileEntity(this.metaTileEntityId, workable.getRecipeMap(), this.renderer,
